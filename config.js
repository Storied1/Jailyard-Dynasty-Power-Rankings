...
function renderNav() {
  ...
  if (!document.getElementById("nav-styles")) {
    ...
    style.textContent = [
      ...
      ".strip-node.latest{width:32px;height:32px;box-shadow:0 0 8px rgba(139,92,246,0.4);}",
      ...
      ".latest-pill .pill-dot{width:8px;height:8px;border-radius:50%;background:var(--accent2);}",
